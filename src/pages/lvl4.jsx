...
export default function Lvl4() {
  ...
  const levelConfig = { bx: -8, by: 8, tx: 8, ty: 4 };
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const obsY = cy - (15) * currentUnitSize; 
      const obsW = 4 * currentUnitSize;
      const obsH = 12 * currentUnitSize; 
    ...
    <div className="h-screen w-screen bg-[#020617] flex overflow-hidden font-mono text-slate-300">
      <aside style={{ width: `${sidebarWidth}px` }} className="bg-[#0f172a] border-r border-blue-500/30 flex flex-col shadow-2xl z-20 relative">
        <div className="p-6 border-b border-blue-500/20 bg-blue-500/5 text-center">
          ...
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-tighter opacity-80 mt-1">BÖLÜM 4: ATEŞTEN GÖMLEK</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-[#020617] rounded-lg border border-purple-500/30 relative">
              ...
              <p className="text-[9px] text-slate-500 mt-3 italic leading-relaxed">
                * Kırmızı lazer duvarına çarpmamak zorundasın! Düz bir çizgi (doğrusal fonksiyon) bu engeli aşamaz.<br/>
                * İpucu: Altından geçip yükselmek için x'in karesini kullanmayı dene (Örn: <strong className="text-purple-300">0.1x^2</strong>).
              </p>
            </div>
